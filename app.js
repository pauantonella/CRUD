...
function mostrarContacto() {
    ...
    listaContactos.forEach(contacto => {
        ...
        parrafo.textContent = `Numero: ${numero} Nombre: ${nombre} Apellido: ${apellido} Estado academico: ${estado_academico}  Estado academico: ${estado_academico}  Estado academico: ${estado_academico}  Estado academico: ${estado_academico} `;
